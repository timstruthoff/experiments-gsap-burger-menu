...
function linkAnim(element) {

    (function () {
        var currentElement = {};
        currentElement.numIndex = i;
        currentElement.element = elements[currentElement.numIndex];
...
function init() {
    ...
    //console.log(newElement(modalHtml))
}
...
window.openMenu = function () {
    ...
    if (transtioning == 0) {
        window.modalElement = newElement(modalHtml);
